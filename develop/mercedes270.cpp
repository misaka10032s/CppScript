...
skilloption angryangel2("angryangel2", {"C", "C", "X", "RSHIFT", "RSHIFT"}, {100, 350, 120, 200, 500}, 100, 25 * 1000);
skilloption javelin("javelin", {"C", "C", "X", "PGD", "PGD"}, {100, 200, 120, 200, 950}, 100, 5 * 1000);
skilloption javelin2("javelin2", {"C", "C", "X", "PGD", "PGD"}, {100, 350, 120, 200, 950}, 100, 25 * 1000);
...
skilloption normal("normal", {"C", "C", "X"}, {100, 350, 600}, 100, 0);
skilloption normal2("normal2", {"C", "C", "X", "X", "X", "X"}, {100, 400, 150, 150, 150, 150}, 50, 10 * 1000);
skilloption cycle("cycle", {"DEL", "DEL"}, {300, 1000}, 100, 300 * 1000);

int main(){
    const char* targetWnd = "MapleStory";
    SYS scriptMS(targetWnd);
    MSsetting infoMS({75, 115}, 999 * 3 * 60 * 1000, {0, 47}, {170, 70}, {cycle, arrow, spider, supernova, knight, sakura, senpuu, angryangel, javelin, angryangel2, javelin2, normal2, normal});
