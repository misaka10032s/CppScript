...
class BIGNUM{
    ...
    public:
        ...
        void leftShift(DIGITDATATYPE NUM1, BIGNUM &res);
        void rightShift(DIGITDATATYPE NUM1, BIGNUM &res);
        void plus(BIGNUM const &NUM1, BIGNUM &res);
        void minus(BIGNUM const &NUM1, BIGNUM &res);
        void multiply(BIGNUM const &NUM1, BIGNUM &res);
        void divideBy(BIGNUM const &NUM1, BIGNUM &res);
        void modulus(BIGNUM const &NUM1, BIGNUM &res);
